...
Pindolol (DB00960) & Beta blocking agents (C07 or S01ED) & Anti-beta2-adrenergic receptor activity agent (FTC\_A0004941) & Erroneous DrugBank annotation \\ \hline
Bopindolol (DB08807) & " & " & Erroneous DrugBank annotation \\ \hline
Practolol (DB01297) & " & " & Ambiguous manual mapping \\ \hline
Atenolol (DB00335) & " & " & Ambiguous manual mapping \\ \hline
Acebutolol (DB01193) & " & " & Erroneous DrugBank annotation \\ \hline
Esmolol (DB00187) & " & " & Missing DrugBank annotation \\ \hline
Bromocriptine (DB01200) & " & " & Missing DrugBank annotation \\ \hline
Bromocriptine (DB01200) & Prolactine inhibitors (G02CB) & Anti-prolactin receptor activity agent (FTC\_A0004925) & Missing DrugBank annotation \\ \hline
...
\begin{tabular}{|p{2cm}|p{4cm}|p{4cm}|p{4cm}|}
\hline
Morphine (DB00295) & Dopamine receptor agonists & Pro-dopamine neurotransmitter receptor activity agent (FTC\_P0004952) & Missing DrugBank annotation or indirect action \\ \hline
Morphine (DB00295) & " & " & Missing DrugBank annotation or indirect action \\ \hline
Isoproterenol (DB01064) & " & " & Missing DrugBank annotation or indirect action \\ \hline
Norepinephrine (DB00368) & " & " & Missing DrugBank annotation or indirect action \\ \hline
Epinephrine (DB00668) & " & " & Missing DrugBank annotation or indirect action \\ \hline
Phenylephrine (DB00388) & " & " & Missing DrugBank annotation or indirect action \\ \hline
Midodrine (DB00211) & " & " & Missing DrugBank annotation or indirect action \\ \hline
Mephentermine (DB01365) & " & " & Missing DrugBank annotation or indirect action \\ \hline
Methoxamine (DB00723) & " & " & Missing DrugBank annotation or indirect action \\ \hline
Metaraminol (DB00610) & " & " & Missing DrugBank annotation or indirect action \\ \hline
Dobutamine (DB00841) & " & " & Missing DrugBank annotation or indirect action \\ \hline
Arbutamine (DB01102) & " & " & Missing DrugBank annotation or indirect action \\ \hline
Ephedrine (DB01364) & " & " & Missing DrugBank annotation or indirect action \\ \hline
Ibudilast (DB05266) & Leukotriene receptor antagonists (R03DC) & Anti-leukotriene receptor activity agent (FTC\_A0004974) & Missing DrugBank annotation \\ \hline
Ephedrine (DB01364) & Selective beta-2-adrenoreceptor agonists (R03AC) & Pro-norepinephrine binding agent (FTC\_P0051380) & Ambiguous manual mapping \\ \hline
Ephedrine (DB01364) & " & " & Ambiguous manual mapping \\ \hline
\end{tabular}
\caption{(continued) Isolation of false negative pairs resulting from the evaluation, alongside an interpretation. Errors are mostly due to missing DrugBank annotations.}
\label{table:falsenegatives2}
\end{table}
...
Figure \ref{fig3-13} presents similar association behaviour when two levels of the ATC are considered (no statistical significance performed). In this case the higher intensity squares are smaller, reflecting the finer resolution of the therapeutic areas (2 ATC levels).
